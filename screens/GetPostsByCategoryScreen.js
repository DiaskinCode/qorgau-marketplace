...
import { View, ScrollView, Image, Text, Modal, StyleSheet,TouchableOpacity, Platform,FlatList,RefreshControl} from 'react-native';
import { useNavigation } from '@react-navigation/native';
import { useDispatch, useSelector } from 'react-redux';
import { logout } from '../actions/authActions';
import { persistor } from '../store/index';
import { ProductCard } from '../components/ProductCard';
import { useGetPostsByCategoryQuery } from '../api';
import {
  IOScrollView,
  InView,
...
export const GetPostsByCategoryScreen = ({route}) => {
    ...
    const { data, isLoading, refetch } = useGetPostsByCategoryQuery({ category_id, page, limit  });
