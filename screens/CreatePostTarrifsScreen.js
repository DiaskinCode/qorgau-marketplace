...
export const CreatePostTarrifsScreen = () => {
    ...
    return (
        <View style={{alignSelf:'center',marginTop:0,width:'90%'}}>
            ...
            <TouchableOpacity onPress={()=>{navigation.navigate('Pay',{tariff:1})}} style={{borderRadius:5,width:'100%',borderWidth:1,borderColor:'#675BFB',marginTop:20}}>
            ...
            <TouchableOpacity onPress={()=>{navigation.navigate('Pay',{tariff:2})}} style={{borderRadius:5,width:'100%',borderWidth:1,borderColor:'#F26F1D',marginTop:20}}>
                ...
                <Text style={{backgroundColor:'#F26F1D',width:'100%',textAlign:'center',paddingVertical:5,marginTop:25,marginBottom:15,fontSize:24,fontWeight:'bold',color:'#F9F6FF'}}>1 500₸</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={()=>{navigation.navigate('Pay',{tariff:3})}} style={{borderRadius:5,width:'100%',borderWidth:1,borderColor:'#01A5C8',marginTop:20}}>
